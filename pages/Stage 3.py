...
if bin_size <= 0:
    ...
    ax.set_title("Histogram (Total Number of Passengers)", fontsize=16)
    ax.set_xlabel("Number of Daily Passengers (Unit: 1,000)", fontsize=14)
    ax.set_ylabel("Frequency(Number of Subway Stations)", fontsize=14)
